...
fof(extra1, axiom, (? [X] : (? [Y] : ((((((attended(williamdickinson, X) & highschool(X)) & locatedin(X, unitedkingdom)) & attended(williamdickinson, Y)) & university(Y)) & locatedin(Y, unitedkingdom)))))).
