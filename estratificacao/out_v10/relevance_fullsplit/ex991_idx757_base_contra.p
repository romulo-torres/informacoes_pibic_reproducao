...
fof(extra1, axiom, ((emilysfriends(taylor) & ((receive(taylor, glowingfeedback, colleague) & receive(taylor, glowingrecommendation, colleague)) & awardwinningnovelist(taylor))))).
