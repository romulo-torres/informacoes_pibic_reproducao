...
fof(extra1, axiom, ~(((atriskof(matt, gamblingaddiction) <~> investinregularly(matt, publicstockmarket)) => (~(enjoyvisiting(matt, thelasvegasstrip)) & ~((readtokeepupdatedon(matt, thewallstreetjournal, financialmetric) | ? [Y] : (((~((Y = thewallstreetjournal)) & newspaper(Y)) & readtokeepupdatedon(matt, Y, financialmetric))))))))).
