...
fof(extra1, axiom, ~(? [X] : (? [Y] : (((((~((X = Y)) & contributedto(X, artificialintelligence)) & contributedto(X, artificialintelligence)) & awardedto(turingaward, X)) & awardedto(turingaward, Y)))))).
