...
fof(p1, axiom, publishedby(thickastheives, greenwillowbooks)).
fof(p2, axiom, ! [X] : (! [Y] : (! [Z] : (((writtenby(X, Y) & publishedby(X, Z)) => workedwith(Y, Z)))))).
fof(p3, axiom, (fictional(medeempire) & setin(thickastheives, medeempire))).
