...
fof(extra1, axiom, (? [X] : (? [Y] : (((((~((X = Y)) & awardedto(turingaward, X)) & awardedto(turingaward, Y)) & contributedto(X, artificialintelligence)) & contributedto(Y, artificialintelligence)))))).
