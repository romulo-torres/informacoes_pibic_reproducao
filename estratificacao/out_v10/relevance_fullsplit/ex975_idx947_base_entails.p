...
fof(extra1, axiom, ~(((havetovisitfrequently(damon, dentist) | drink(damon, kombucha, everyday)) => (havetovisitfrequently(damon, dentist) & ? [Y] : ((drink(x, cocacola) | (pepsiproduct(Y) & drink(x, Y)))))))).
