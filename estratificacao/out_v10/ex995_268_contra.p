...
fof(extra1, axiom, (((? [Y] : (((((resist(robert, Y) & hallmark(Y)) & delectabl(Y)) & dessert(Y)) & famousin(Y, italy))) & regret(robert, collegeexperience)) => (enjoyeating(robert, gelato) <~> (enjoy(robert, vacation) & in(vacation, italy)))))).
