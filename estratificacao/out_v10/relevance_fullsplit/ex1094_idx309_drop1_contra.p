...
fof(extra1, axiom, (((considersmostimportantlovelanguage(adam, physicaltouch, mostimportantlovelanguage) | goodwith(x, pet)) => considersmostimportantlovelanguage(adam, wordofaffirmation)))).
