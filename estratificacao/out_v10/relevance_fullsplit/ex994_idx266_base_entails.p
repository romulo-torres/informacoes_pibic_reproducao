...
fof(extra1, axiom, ~((~(((enjoy(robert, vacation) & in(vacation, italy)) <~> regret(x, collegeexperiences))) => ((enjoy(robert, vacation) & in(vacation, italy)) <~> ? [Y] : (((((resist(robert, Y) & hallmark(Y)) & delectabl(Y)) & dessert(Y)) & famousin(Y, italy))))))).
