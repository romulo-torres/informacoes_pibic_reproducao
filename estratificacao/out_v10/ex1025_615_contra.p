...
fof(extra1, axiom, (((enjoy(thomas, shopping, materialisticitem) <~> gotospafrequently(thomas)) => ~(((value(x, qualitymanufacturing) & value(x, luxuryitem)) | gotospafrequently(thomas)))))).
