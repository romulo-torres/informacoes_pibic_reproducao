...
fof(extra1, axiom, ((invitedtotakephotowith(james, audience) => ? [Y] : (? [Z] : (((((~((Y = james)) & ~((Z = james))) & ~((Y = Z))) & happytocommunicatewithduringthedinner(james, Y)) & happytocommunicatewithduringdinner(james, Z))))))).
