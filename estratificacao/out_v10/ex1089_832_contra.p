...
fof(extra1, axiom, (((mindreading(multivoxelpatternanalysis) & novelwriting(multivoxelpatternanalysis)) => (uses(multivoxelpatternanalysis, statisticalpatternanalysis) | ~(novelwriting(multivoxelpatternanalysis)))))).
